...
/**
 * ARCHBRAIN MCP - Architectural Operating System v1.0
 * 
 * Bu modül, Yapay Zeka (AI) ve Dosya Sistemi arasında bir köprüdür.
 * Görevi: Dosyalarla uğraşmak yerine "Niyet"leri (Intent) mimariye dönüştürmektir.
 */
