...
const GitOpsPage = () => {
  ...
  const steps = [
    { title: 'Code', icon: <Code2 />, desc: 'Developer writes code and pushes it to Git.' },
    { title: 'Config', icon: <Server />, desc: 'Infrastructure (Kubernetes YAML, etc.) also lives in Git as code.' },
    { title: 'Sync', icon: <RefreshCw />, desc: 'ArgoCD/Flux continuously reconciles the live system with Git.' },
    { title: 'Live', icon: <Cloud />, desc: 'Live environment is an exact mirror of the Git repo.' }
  ];
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ background: 'var(--bg-dark)', minHeight: '100vh' }}>
      <ArchHero
        title="GitOps"
        subtitle="& IaC"
        description="Operational processes managed through Git under the 'Infrastructure as Code' principle, not manually. Git is the Single Source of Truth (SSOT)."
        ...
        features={[
          { icon: <GitBranch />, title: 'Version Control', desc: 'Version and roll back server changes like code.' },
          { icon: <Code2 />, title: 'Declarative', desc: 'Define the desired state, not the steps to reach it.' },
          { icon: <RefreshCw />, title: 'Auto Healing', desc: 'If the live environment drifts, the system auto-corrects by reconciling against Git.' }
        ]}
      />
      ...
      <section style={{ padding: '80px 0' }}>
        <div className="container">
           ...
           <div className="glass-card" style={{ maxWidth: '800px', margin: '3rem auto', padding: '3rem', textAlign: 'center' }}>
              <h3 style={{ color: '#f97316', fontSize: '1.5rem', marginBottom: '1rem' }}>{steps[activeTab].title} Phase</h3>
           ...
           <div style={{
             ...
             margin: '0 auto'
              ...
              <p style={{ color: '#94a3b8', marginBottom: '2rem', fontSize: '1.1rem', lineHeight: 1.6 }}>
                GitOps principles follow the standards set by the OpenGitOps working group under the Cloud Native Computing Foundation (CNCF).
              </p>
