  ...
  return (
    ...
    >
      <ArchHero 
        ...
        description="Small interactive JavaScript islands floating in an ocean of static HTML content. Minimum JS for maximum performance."
        ...
        features={[
          { icon: <Zap />, title: 'Zero JS by Default', desc: '90% of the page arrives as static HTML, JS only loaded where needed.' },
          { icon: <Anchor />, title: 'Partial Hydration', desc: 'Rather than hydrating the entire page, it only hydrates the interactive islands.' },
          { icon: <Layers />, title: 'Component Driven', desc: 'You can use framework-agnostic components (React, Vue, Svelte) on the same page.' }
        ]}
      />
      ...
      <section style={{ padding: '80px 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <h2 className="gradient-text" style={{ fontSize: '3rem', fontWeight: 800 }}>Living Islands in a Static Ocean</h2>
            <p style={{ color: 'var(--text-secondary)' }}>Users only pay the cost of what they see.</p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                 ...
                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                       ...
                       <div style={{ padding: '6px 12px', background: '#0ea5e9', borderRadius: '6px', fontSize: '0.8rem', color: 'white', display: 'flex', gap: '6px' }}>
                          <ShoppingBag size={14} /> Cart (Interactive Island)
                       </div>
                    </div>
                 </div>
               </motion.div>
               ...
               <div style={{ height: '200px', background: '#1e293b', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <span style={{ color: '#475569' }}>Static HTML Banner (0kb JS)</span>
               </div>
