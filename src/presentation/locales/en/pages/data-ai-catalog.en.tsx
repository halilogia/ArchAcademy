...
const DataAICatalogPage: React.FC = () => {
  ...
  const items: ArchItem[] = [
    { id: 'rag', name: 'RAG Arch', path: '/rag-arch', color: '#8b5cf6', icon: <Brain />, desc: 'Retrieval Augmented Generation: LLM efficiency.', pos: { x: 30, y: 35 } },
    { id: 'agents', name: 'Agentic AI', path: '/agentic-ai', color: '#ef4444', icon: <Cpu />, desc: 'Autonomous decision-making AI agents.', pos: { x: 25, y: 60 } },
    { id: 'vector', name: 'Vector DBs', path: '/vector-dbs', color: '#3b82f6', icon: <Database />, desc: 'Efficient storage and search of high-dimensional data (Embeddings).', pos: { x: 45, y: 45 } },
    { id: 'cqrs', name: 'CQRS', path: '/cqrs', color: '#ec4899', icon: <Activity />, desc: 'Separation of Command and Query responsibilities.', pos: { x: 65, y: 30 } },
    { id: 'eventsourcing', name: 'Event Sourcing', path: '/event-sourcing', color: '#f59e0b', icon: <Layers />, desc: 'Storing state as a sequence of events.', pos: { x: 70, y: 55 } },
    ...
    { id: 'acid', name: 'ACID', path: '/acid', color: '#10b981', icon: <ShieldCheck />, desc: 'Database transaction integrity rules.', pos: { x: 40, y: 20 } },
    { id: 'lambda-kappa', name: 'Lambda & Kappa', path: '/lambda-kappa', color: '#06b6d4', icon: <Network />, desc: 'Big data processing (Stream vs Batch) architectures.', pos: { x: 80, y: 40 } },
    { id: 'llmops', name: 'LLMOps', path: '/llm-ops', color: '#6366f1', icon: <Zap />, desc: 'Operational processes for AI models.', pos: { x: 15, y: 50 } },
  ];
