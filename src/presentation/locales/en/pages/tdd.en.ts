  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <ArchHero 
        ...
        description="Test-Driven Development. Discipline of writing tests before developing software. Power of the Red-Green-Refactor cycle."
        badge="Quality First"
        color="#10b981"
        illustration={
        ...
        features={[
          { icon: <Bug />, title: "Zero Bug Goal", desc: "Bugs prevented by tests before they occur." },
          { icon: <Cpu />, title: "Clean Design", desc: "Writing tests forces you to write more modular code." },
          { icon: <CheckCircle2 />, title: "Safe Refactoring", desc: "Changing code isn't scary when tests exist." }
        ]}
      />
          ...
          <div className="glass-card" style={{ padding: '4rem', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', justifyContent: 'center', flexWrap: 'wrap' }}>
               <div style={{ flex: 1, minWidth: '250px', padding: '2rem', borderRadius: '24px', background: 'rgba(239, 68, 68, 0.1)', border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                  ...
                  <p>Write test for the feature you haven't written yet and watch it fail.</p>
               </div>
               <div style={{ flex: 1, minWidth: '250px', padding: '2rem', borderRadius: '24px', background: 'rgba(16, 185, 129, 0.1)', border: '1px solid rgba(16, 185, 129, 0.2)' }}>
                  ...
                  <p>Write enough (minimum) code to pass test.</p>
               </div>
               <div style={{ flex: 1, minWidth: '250px', padding: '2rem', borderRadius: '24px', background: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.2)' }}>
                  ...
                  <p>Clean code, conform to standards; check tests still green.</p>
               </div>
            </div>
          </div>
        </div>
           ...
           <div style={{ 
             ...
             margin: '0 auto'
              ...
              <p style={{ color: '#94a3b8', marginBottom: '2rem', fontSize: '1.1rem', lineHeight: 1.6 }}>
                TDD is not a testing method, but a design method. Explore details of this discipline popularized by Kent Beck.
              </p>
