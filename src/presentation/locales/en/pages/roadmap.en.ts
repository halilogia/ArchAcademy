  ...
  const TabSwitcher = () => (
    <div style={{ 
      ...
      zIndex: 10
        ...
        >
          <GraduationCap size={20} /> Architecture Curriculum
        </button>
        <button
          ...
          {activeTab === 'career' ? (
            ...
            >
              ...
              <h1 className="gradient-text" style={{ fontSize: '4.5rem', fontWeight: 950, marginBottom: '1.5rem', letterSpacing: '-2px', lineHeight: 1 }}>
                Architecture <br/>Curriculum
              </h1>
              <p style={{ color: 'var(--text-secondary)', fontSize: '1.3rem', maxWidth: '800px', margin: '0 auto 3rem', lineHeight: 1.6, fontWeight: 500 }}>
                Explore software architecture disciplines from fundamentals to advanced levels with a structured curriculum. 
                <span style={{ color: 'var(--primary)', fontWeight: 700 }}> Senior Architect</span> journey starts here. Master SOLID, Design Patterns, and Clean Architecture fundamentals.
              </p>
            </motion.div>
          ) : (
            <motion.div
            ...
            >
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '1.3rem', maxWidth: '800px', margin: '0 auto 3rem', lineHeight: 1.6, fontWeight: 500 }}>
                Journey of code from idea to end user. <br/>
                Discover the synergy of <span style={{ color: '#f43f5e', fontWeight: 700 }}>DevOps + Architect</span> from containers to Kubernetes orchestration. Experience the power of automation.
              </p>
          ...
          <div className="container">
              <div className="glass-card" style={{ 
                  ...
                  <div style={{ flex: 1, minWidth: '300px' }}>
                      <h2 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '1.5rem' }}>Where Do I Start?</h2>
                      <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', lineHeight: 1.7, marginBottom: '2rem' }}>
                          Software architecture cannot be learned overnight. You must internalize every layer and design by experiencing them in your projects. 
                          ArchAcademy guides you on this path, but the real difference will be made by you writing code.
                      </p>
                      <button style={{ 
                        ...
                        Join Learning Group <Users size={20} />
                      </button>
                  </div>
                  <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', minWidth: '300px' }}>
                      {[
                          { title: '70+ Lessons', sub: 'Curated Content', icon: <BookOpen size={20} color="var(--primary)" /> },
                          { title: '20+ Diagrams', sub: 'Visual Storytelling', icon: <Sparkles size={20} color="var(--primary)" /> },
                          { title: 'Real World', sub: 'Case Studies', icon: <Trophy size={20} color="var(--primary)" /> },
                          { title: 'Community', sub: 'Dev Support', icon: <Users size={20} color="var(--primary)" /> }
                      ].map((stat, i) => (
                          <div key={i} className="glass-card" style={{ padding: '2rem 1.5rem', textAlign: 'center', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.03)' }}>
                              ...
                              <div style={{ fontSize: '1.8rem', fontWeight: 950, color: 'white',