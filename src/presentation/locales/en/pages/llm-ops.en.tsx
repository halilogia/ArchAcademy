  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ background: 'var(--bg-dark)', minHeight: '100vh' }}>
      <ArchHero 
        title="LLMOps"
        subtitle="Platform"
        description="Discipline of managing, monitoring, and continuously improving Large Language Models (LLMs) in production. New evolution of MLOps."
        ...
        features={[
          { icon: <Settings />, title: 'Prompt Management', desc: 'Prompt versioning and A/B testing.' },
          { icon: <GitBranch />, title: 'Fine-Tuning', desc: 'Training general models (Llama, Mistral) on custom data.' },
          { icon: <BarChart />, title: 'Evaluation (Evals)', desc: 'Scoring model outputs for accuracy and safety.' }
        ]}
      />
        ...
        <div className="container" style={{ textAlign: 'center' }}>
           <div style={{ display: 'inline-flex', alignItems: 'center', gap: '1rem', background: 'rgba(16, 185, 129, 0.1)', padding: '1rem 2rem', borderRadius: '12px', border: '1px solid rgba(16, 185, 129, 0.2)' }}>
              ...
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontSize: '0.8rem', color: '#6ee7b7', textTransform: 'uppercase' }}>Core Resource</div>
