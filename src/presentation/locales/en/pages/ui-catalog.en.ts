...
const UIArchitectureCatalogPage = () => {
    ...
    const items: UIArchItem[] = [
        { id: 'atomic', name: 'Atomic Design', path: '/atomic-design', color: '#3b82f6', icon: <Palette size={24} />, desc: 'Atom -> Molecule -> Organism. UI component hierarchy.' },
        { id: 'sdui', name: 'Server-Driven UI', path: '/server-driven-ui', color: '#8b5cf6', icon: <Server size={24} />, desc: 'Render whatever the backend dictates. Dynamic UI management.' },
        { id: 'islands', name: 'Islands Arch', path: '/islands-arch', color: '#f59e0b', icon: <Layout size={24} />, desc: 'Hydrate only interactive islands (Astro).' },
        { id: 'tokens', name: 'Design Tokens', path: '/design-tokens', color: '#ec4899', icon: <CreditCard size={24} />, desc: 'Color, font, spacing... Atomic constants of design.' },
        { id: 'microfe', name: 'Micro-Frontends', path: '/micro-frontends', color: '#06b6d4', icon: <Puzzle size={24} />, desc: 'Break up and manage monolithic frontend.' },
        { id: 'state', name: 'State-Driven UI', path: '/state-driven', color: '#22c55e', icon: <RefreshCcw size={24} />, desc: 'UI = f(State). Reactive interface paradigm.' },
        { id: 'cdd', name: 'Component-Driven', path: '/component-driven', color: '#f43f5e', icon: <Puzzle size={24} />, desc: 'Start from components, not pages (CDD).' },
        { id: 'composite', name: 'Composite UI', path: '/composite-ui', color: '#8b5cf6', icon: <Layers size={24} />, desc: 'Runtime composition of different modules.' },
        { id: 'spa-mpa', name: 'SPA vs MPA', path: '/spa-vs-mpa', color: '#10b981', icon: <Globe size={24} />, desc: 'Single Page (SPA) vs Multi Page (MPA) render strategies.' },
        { id: 'comp-state', name: 'Component State', path: '/component-state', color: '#6366f1', icon: <Database size={24} />, desc: 'Component-based state management and data flow.' }
    ];
