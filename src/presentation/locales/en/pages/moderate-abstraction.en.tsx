  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <ArchHero 
        ...
        description="Abstraction is a powerful weapon, but too much of it turns into 'Over-Engineering' poison. Perfect architecture is neither too shallow nor too deep."
        badge="Balance is Key"
        color="#93c5fd"
        illustration={illu}
        features={[
          { icon: <Scale />, title: 'Goldilocks Principle', desc: 'Not too hot, not too cold. Your abstraction level should match the complexity of the problem.' },
          { icon: <Hammer />, title: 'YAGNI', desc: '"You Aren\'t Gonna Need It". Don\'t write a Generic Interface now just because you might need it later.' },
          { icon: <Gauge />, title: 'Cognitive Load', desc: 'Each new layer adds extra cognitive load to a new developer.' }
        ]}
      />
      ...
      <section className="section-padding">
        <div className="container">
           <div className="glass-card" style={{ padding: '3rem' }}>
              <h2 className="gradient-text" style={{ fontSize: '2rem', marginBottom: '2rem' }}>Abstraction Traps</h2>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                 <div>
                    <h3 style={{ color: '#ef4444', marginBottom: '1rem' }}>Under-Abstraction</h3>
                    <p style={{ color: '#cbd5e1', lineHeight: 1.6 }}>
                       If you don't abstract at all, your code repeats itself (DRY violation) and becomes resistant to change. 
                       For example: writing SQL queries directly in a UI component.
                    </p>
                 </div>
                 <div>
                    <h3 style={{ color: '#f59e0b', marginBottom: '1rem' }}>Over-Abstraction (Lasagna Code)</h3>
                    <p style={{ color: '#cbd5e1', lineHeight: 1.6 }}>
                       If you write 5 Interfaces, 3 Factories, and 2 Adapters just to print "Hello World", you are on the wrong path.
                       The person reading the code should not get lost asking "Where is the actual work done?"
                    </p>
                 </div>
              </div>
           </div>
