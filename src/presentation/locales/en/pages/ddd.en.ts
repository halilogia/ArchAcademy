          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
            ...
            <div className="glass-card" style={{ borderTop: '4px solid #7c3aed' }}>
               ...
               <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: '2rem' }}>
                  High-level decisions used to break large, complex systems into manageable pieces.
                  Developers and business experts must speak the same language.
               </p>
               <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <li style={{ background: 'rgba(124, 58, 237, 0.1)', padding: '12px', borderRadius: '8px' }}>
                    <strong style={{ color: 'white' }}>Bounded Context:</strong> Boundaries where a word (e.g., Product) carries different meanings for different teams.
                  </li>
                  <li style={{ background: 'rgba(124, 58, 237, 0.1)', padding: '12px', borderRadius: '8px' }}>
                    <strong style={{ color: 'white' }}>Ubiquitous Language:</strong> Common language used by the whole team (from analysts to developers).
                  </li>
               </ul>
            </div>
            ...
            <div className="glass-card" style={{ borderTop: '4px solid #10b981' }}>
               ...
               <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: '2rem' }}>
                  Technical patterns focused on how to model business logic at the code level.
               </p>
               <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                  {[
                    { t: 'Entity', d: 'Objects with identity.' },
                    { t: 'Value Object', d: 'Values without identity.' },
                    { t: 'Aggregate', d: 'Manager of a group of objects.' },
                    { t: 'Repository', d: 'Data access abstraction.' }
                  ].map((item, i) => (
             ...
             <div style={{ 
               ...
               margin: '0 auto'
                ...
                <p style={{ color: '#94a3b8', marginBottom: '2rem', fontSize: '1.1rem', lineHeight: 1.6 }}>
                  This content is based on Eric Evans' "Domain-Driven Design" book and the reference documents published by the Domain Language community.
                </p>
