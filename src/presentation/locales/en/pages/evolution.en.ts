  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ background: '#020617', minHeight: '100vh', color: 'white' }}>
      <ArchHero   
        ...
        description="'Evolutionary architecture supports guided, incremental change across multiple dimensions.' Neal Ford's architecture discipline that adapts to a changing world."
        badge="Incremental Change"
        color="#ec4899"
        illustration={illu}
        features={[
          { icon: <GitBranch />, title: 'Incremental Change', desc: 'Improve the system continuously instead of trying to make it perfect in one go.' },
          { icon: <ShieldAlert />, title: 'Fitness Functions', desc: 'Protect architecture health with automated tests for performance and security.' },
          { icon: <Layers />, title: 'Appropriate Coupling', desc: 'Manage dependencies correctly so each part can change independently.' }
        ]}
      />
      ...
      <section style={{ padding: '80px 0', borderTop: '1px solid var(--glass-border)' }}>
        <div className="container">
           <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '1rem', fontWeight: 800 }}>Fitness Functions: Guardians of Architecture</h2>
              <p style={{ maxWidth: '800px', margin: '0 auto', fontSize: '1.1rem', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
                Unit tests measure whether code works correctly. Fitness Functions measure whether the architecture works correctly.
              </p>
           </div>
      ...
      <section style={{ padding: '80px 0', background: 'rgba(255,255,255,0.02)' }}>
        <div className="container">
           <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'center' }}>
              <div>
                 <h2 style={{ fontSize: '2.5rem', marginBottom: '1.5rem' }}>Example: Netflix Chaos Monkey</h2>
                 <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7, fontSize: '1.1rem' }}>
                    Developed to keep the system always available, <b>Chaos Monkey</b> shuts down servers randomly to measure the architecture's resilience (Fitness).
                 </p>
              </div>
           ...
           <div style={{ 
             ...
             margin: '0 auto'
              ...
              <p style={{ color: '#94a3b8', marginBottom: '2rem', fontSize: '1.1rem', lineHeight: 1.6 }}>
                Explore Neal Ford's work on architectural structures that support change over time, Fitness Functions, and chaos engineering.
              </p>
