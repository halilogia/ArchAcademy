...
const RefactoringPage = () => {
  ...
  const stats = [
    { icon: <Microscope size={20} />, label: "Detailed Analysis", value: "Anti-Pattern Detection" },
    { icon: <Zap size={20} />, label: "Instant Transformation", value: "Clean Code Refactor" },
    { icon: <BookOpen size={20} />, label: "Educational Rationale", value: "Architectural Principles" }
  ];
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
          ...
          <p style={{ fontSize: '1.25rem', color: 'var(--text-secondary)', maxWidth: '800px', margin: '0 auto', lineHeight: 1.8 }}>
            We transform scary-looking spaghetti code and complex file structures into pristine structures using architectural surgery techniques.
            See the pathology, start the surgery, and watch the code breathe.
          </p>
           ...
           <div style={{ 
             ...
             margin: '0 auto'
              ...
              <p style={{ color: '#94a3b8', marginBottom: '2rem', fontSize: '1.1rem', lineHeight: 1.6 }}>
                Martin Fowler's "Refactoring: Improving the Design of Existing Code" is the bible of this discipline. You can browse his online catalog here.
              </p>
