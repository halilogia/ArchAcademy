  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ background: 'var(--bg-dark)', minHeight: '100vh' }}>
      <ArchHero 
        title="Zero Trust"
        subtitle="Security"
        description="'Never Trust, Always Verify'. Even devices inside the network are considered untrusted by default."
        ...
        features={[
          { icon: <UserCheck />, title: 'Identity First', desc: 'Trust identity, not IP address.' },
          { icon: <EyeOff />, title: 'Least Privilege', desc: 'Grant only the minimum permissions needed to do the job.' },
          { icon: <Fingerprint />, title: 'Micro-Segmentation', desc: 'Even if one server is hacked, an attacker cannot move to an adjacent server.' }
        ]}
      />
           ...
           <div style={{ 
             ...
             margin: '0 auto'
              ...
              <p style={{ color: '#94a3b8', marginBottom: '2rem', fontSize: '1.1rem', lineHeight: 1.6 }}>
                Zero Trust architecture is standardized by the U.S. National Institute of Standards and Technology (NIST) in publication "SP 800-207".
              </p>
