UI strings translated. Code/identifiers/imports untouched.
      ...
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', maxWidth: '600px', margin: '0 auto' }}>
            We simplified complex architecture terms so you crush interviews. Master the concepts, command the systems.
          </p>
        </div>
        ...
        <div style={{ marginBottom: '3rem' }}>
          <div className="glass-card" style={{
            ...
            <input
              type="text"
              placeholder="Search terms... (e.g. Coupling)"
              value={searchTerm}
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ fontSize: '0.8rem', color: 'var(--primary)', fontWeight: 500 }}>
                  <strong style={{ opacity: 0.7 }}>PRO TIP:</strong> {item.guruTip}
                </div>
              </div>
            </motion.div>
          ))}
        ...
        {filteredTerms.length === 0 && (
          <div style={{ textAlign: 'center', padding: '5rem', opacity: 0.5 }}>
            ...
            <p>The term you searched for isn't in our glossary yet.</p>
          </div>
        )}
      </div>
      {/* Back to Top Button */}
...
Translation notes:
- Turkish subtitle → idiomatic English taglines, punchy.
- `guruTip` field name intact (data identifier), label `GURU TIP` → `PRO TIP` (UI label).
- Unused imports retained: `Filter`, `HelpCircle`, `BookOpen`, `Zap`, `Shield`, `Cpu`, `Terminal`, `Globe`, `Database`, `Bookmark`, `AnimatePresence` — match source, not silently delete.