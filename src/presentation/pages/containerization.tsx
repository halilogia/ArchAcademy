...
const ContainerizationPage: React.FC = () => {
  ...
  const scrollToSection = (id: 'fundamentals' | 'dockerfile' | 'k8s' | 'simulation') => {
    setActiveTab(id);
    ...
    <>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ background: 'var(--bg-dark)', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ marginTop: '2rem' }}>
          ...
          <div id="fundamentals" style={{ scrollMarginTop: "100px" }}>
            <ContainerFundamentalsTab />
          </div>
          <div id="dockerfile" style={{ scrollMarginTop: "100px" }}>
            <DockerfileOptimizationTab />
          </div>
          <div id="k8s" style={{ scrollMarginTop: "100px" }}>
            <KubernetesOrchestrationTab />
          </div>
          <div id="simulation" style={{ scrollMarginTop: "100px" }}>
            <ContainerLifecycleSimulationTab />
          </div>
        </div>
        </div>
