                ...
                <div className="container" style={{ textAlign: 'center' }}>
                    <div style={{ 
                        ...
                        <p style={{ color: '#94a3b8', marginBottom: '2rem', fontSize: '1.1rem', lineHeight: 1.6 }}>
                            Lambda mimarisinin yaratıcısı Nathan Marz ve Kappa mimarisini popülerleştiren Jay Kreps'in temel yazılarını inceleyerek bu sistemlerin teorik temellerini öğrenebilirsiniz.
                        </p>
