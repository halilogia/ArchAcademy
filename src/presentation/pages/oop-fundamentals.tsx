    ...
    <>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ background: 'var(--bg-dark)', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ marginTop: '2rem' }}>
          ...
          <div id="pillars" style={{ scrollMarginTop: "100px" }}>
            <OOPPillarsTab />
          </div>
          <div id="composition" style={{ scrollMarginTop: "100px" }}>
            <CompositionOverInheritanceTab />
          </div>
          <div id="domainmodels" style={{ scrollMarginTop: "100px" }}>
            <AnemicVsRichDomainTab />
          </div>
          <div id="simulation" style={{ scrollMarginTop: "100px" }}>
            <OOPPolymorphismSimulationTab />
          </div>
        </div>
        </div>
