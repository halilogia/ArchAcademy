...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
    ...
    {
      term: 'Atomic Design (Atomik Tasarım)',
      definition: 'Arayüzün atomlar (buton), moleküller (form) ve organizmalar (nav-bar) gibi hiyerarşik parçalara bölünerek geliştirilmesi metodolojisidir.',
      category: 'Frontend',
      guruTip: 'UI bileşenlerini bu disiplinle kurmak, tasarımın tutarlılığını ve kodun yeniden kullanılabilirliğini (reusability) zirveye taşır.'
    },
    {
